...
public class BoardPanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		if(game.isGameOver() || game.isNewGame() || game.isPaused()) {
			...
			if(game.isNewGame()) {
				largeMessage = "Snake O'yin!";
				smallMessage = "Boshlash uchun ENTER ni bosing";
			} else if(game.isGameOver()) {
				largeMessage = "Yutqazdingiz!";
				smallMessage = "O'ynash uchun ENTER ni bosing";
			} else if(game.isPaused()) {
				largeMessage = "Pauza";
				smallMessage = "Davom ettirish uchun SPACE ni bosing";
			}
